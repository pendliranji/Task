...
<body>
	<table border="2">
		<form:form action="save" method="post" modelAttribute="employee"
			...
			<tr>
				<th>Roles :</th>
				<th><form:radiobutton path="roles" value="ADMIN" />ADMIN <form:radiobutton
						path="roles" value="USER" />USER <form:radiobutton path="roles"
						value="SUPER_USER" />SUPER_USER</th>
	...
	<%-- <%
		...
		if (ses != null && ses.getAttribute("name") != null) {
			...
			out.println("<b><button><a href=log>Login Employee</a><button></b>");
		}
	%>
 --%>
</body>
